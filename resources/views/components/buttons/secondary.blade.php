...
@php
$classes = $default ?? true ? 'w-full text-white text-sm capatalize py-2 px-4 leading-6 cursor-pointer inline-flex flex-row justify-center items-center no-underline rounded-md font-semibold cursor-pointer transition duration-200 ease-in-out shadow-md shadow-teal-100 bg-teal-500' : 'capatalize text-sm py-2 px-4 leading-6 cursor-pointer inline-flex flex-row justify-center items-center no-underline rounded-md font-semibold cursor-pointer  transition duration-200 ease-in-out';
@endphp
