<form wire:submit.prevent="update">
            ...
            <div>
                <x-modals.full modal="isModalOpen">
                    ...
                    <div class=" my-6">
                        ...
                        @if ($photo)
                            <span class="text-gray-600 text-base font-bold mt-5">image Preview:</span>

                            <div class="relative  pt-[60%] rounded-xl sm:pt-[50%] md:pt-[42%] my-5">
                                <img class="absolute top-0 bottom-0 left-0 right-0 w-full h-full m-0 bg-white shadow-md object-fit rounded-xl drop-shadow-md dark:bg-gray-800"
                                    src="{{ $photo->temporaryUrl() }}" alt="" />
                            </div>
                        @endif
    ...
    <div class=" px-2 mt-2 text-gray-700 sm:px-6 sm:mt-6 md:px-20">
        ...
        <div>
            ...
            {{-- <div wire:model="body" id="editor" wire:ignore
    ...
    @push('scripts')
        <script data-turbolinks-eval="false">
            document.addEventListener('turbolinks:load', function() {
                ...
                var editor = milkdown.editor.config((ctx) => {
                    ctx.get(milkdown.listenerCtx)
                        .beforeMount((ctx) => {
                            console.log('mout update')
                        })
                        .mounted((ctx) => {
                            console.log('mouted update')
                        })
